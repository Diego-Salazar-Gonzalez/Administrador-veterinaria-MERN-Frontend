...
const CambiarPassword = () => {
    ...
    const handleSubmit = async e =>{
        ...
        if(password.pwd_nuevo.lenght <= 6){
            setAlerta({
                msg: 'La contraseña nueva debe de ser al menos de 6 caracteres',
                error: true
            })
        }
            ...
            <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                ...
                >
                    ...
                    <input
                        ...
                        className="bg-indigo-700 px-10 cursor-pointer py-3 font-bold text-white rounded-lg uppercase w-full mt-5"
                    />
                </form>
            </div>
        </div>
